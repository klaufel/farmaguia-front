export const pharmaciesResponse = [
  ...
  {
    id: '4ad6dd7e-5fe5-4f3b-b41d-6bcce1d71144',
    name: 'Farmacia Yago Torregrosa',
    pharmacist: 'Torres Tomás-López Torres',
    phone: '968751165',
    address: 'C. de Cruz de Piedra, 37',
    municipality: 'Yecla',
    province: 'Murcia',
    zipCode: '30510',
    coordinates: [38.6166013, -1.1055883],
    email: '',
    sanitaryAuth: '',
    social: {
      facebook: '',
